...
const profit = [
    ...
    /* {
         title: 'How do we Profit as a Company ?',
         text: `
     15% of whatever profit made at the end of a trade-session is to be paid by account holder to
                             ${name} The 2 different TradeForMe Categories comes with their different offers,
                             Interested traders kindly contact us for more information T&Cs Apply. Are you still reading
 ...
 <br>
                             ...
                             <br>
                             <br>
                             Overtime as a goal driven team with a solid workforce, we also developed the highly
    ...
    // new profirt
    {
        ...
        title: 'PROFIT',
        text: `  15% of whatever profit made at the end of a trade-session is to be paid by account holder to
                            ${name} The 2 different TradeForMe Categories comes with their different offers,
                            Interested traders kindly contact us for more information T&Cs Apply. Are you still reading
                            this? contact us right away to experience it all first hand. contact@${domain}`,
    },
